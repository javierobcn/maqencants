    ...
    def _compute_share_url(self):
        ...
        for product in self:
            ...
            dict.update({
                ...
                'twitter': 'https://twitter.com/intent/tweet?tw_p=tweetbutton&text=En Maquinaria Encants: {}{}'.format(
                ...
                'pinterest': 'http://pinterest.com/pin/create/button/?url={}{}&description={} {}{}'.format(
                    protocol, url_format.replace('%5C', ''), 'En Maquinaria Encants', protocol,
                    url_host.replace('%5C', '')),
